...
$query = "SELECT user_id, user_firstname, user_lastname, user_major, user_email, application_key FROM tbl_user INNER JOIN tbl_application ON tbl_user.user_id = tbl_application.event_applier WHERE tbl_application.event_key = $event_key AND tbl_application.application_status = 'accepted'";
